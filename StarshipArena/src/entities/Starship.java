...
public class Starship {
	...
	public int damageDisplayDelay = 0;
	public Starship target = null;
	...
	public String team;
	public ArrayList<Integer> control_groups = new ArrayList<>();
	public double angle;
	public double move_angle;
	public double targeted_velocity;
	public double current_velocity = 0;
	public double current_turn_speed;
	...
	public double max_reverse_velocity;
	public double min_turn_velocity;
	public double max_turn_speed;
	public int scan_range;
	public int radar_range;
	...
	public boolean attackMove = true;
	public boolean directTarget = false;
