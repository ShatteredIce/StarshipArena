...
public class Transport extends Starship{
	...
	public Transport(StarshipArena mygame, double spawnx, double spawny){
		super(mygame, spawnx, spawny);
	}
	
	public Transport(StarshipArena mygame, double spawnx, double spawny, double spawnangle){
		super(mygame, "none", spawnx, spawny, spawnangle);
	}

	public Transport(StarshipArena mygame, String newteam, double spawnx, double spawny, double spawnangle){
