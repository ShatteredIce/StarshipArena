...
//		}
	...
	public void performAttack() {
		...
		for (int i = 0; i < myShips.size(); i++) {
			if (myShips.get(i) instanceof Fighter && myShips.get(i).locationTarget == null) costOfShips += StarshipArena.FIGHTER_COST;
			else if (myShips.get(i) instanceof Interceptor && myShips.get(i).locationTarget == null) costOfShips += StarshipArena.INTERCEPTOR_COST;
			else if (myShips.get(i) instanceof Missileship && myShips.get(i).locationTarget == null) costOfShips += StarshipArena.MISSILESHIP_COST;
